...
$id = $_POST['id'];
$kolom = get_single_data($koneksi, "sdm", "id_sdm", $id);
?>

<form method="post" enctype="multipart/form-data" action="aksi/sdm.php">
    <input type="hidden" name="aksi" value="ubah">
    <input type="hidden" name="id_sdm" value="<?= $kolom['id_sdm']; ?>">
    ...
    <div>
        ...
        <select name="id_sdm_jabatan" class="form-control" required>
            ...
            <?= call_option_selected($koneksi, "sdm_jabatan", "id_sdm_jabatan", "id_sdm_jabatan", "jabatan",$kolom['id_sdm_jabatan']); ?>
        </select>
    </div>
    <div class="row">
        <div class="col-md-6">
