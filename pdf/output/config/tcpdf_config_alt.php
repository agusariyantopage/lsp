 ...
 */
define ('PDF_HEADER_LOGO', "../../../$APP_LOGO");
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', $APP_TITLE.' '.$APP_VERSION);

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "$APP_COMPANY_NAME\n$APP_COMPANY_ADDRESS Telp:$APP_COMPANY_PHONE Email:$APP_COMPANY_EMAIL");
